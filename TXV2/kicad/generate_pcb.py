...
back = [("C1","1uF",C08,129,122,{"1":"VBUS_USB","2":"GND"}),
        ...
        ("C6","47nF",C08,138,126,{"1":"BTST","2":"SW_CHG"}),
        ("C7","4.7uF",C08,129,130,{"1":"REGN","2":"GND"}),
        ("R1","330R",R08,138,130,{"1":"MID_SENSE","2":"CELL_MID"}),
        ("R2","68R",R12F,129,134,{"1":"CB_PATH","2":"CELL_MID"}),
        ("R3","68R",R12F,132,134,{"1":"CB_PATH","2":"CELL_MID"}),
        ("R4","5.11k",R08,135,134,{"1":"REGN","2":"CHG_TS"}),
        ("R5","7.5k",R08,138,134,{"1":"CHG_TS","2":"GND"}),
        ("R6","374R",R08,129,155,{"1":"CHG_ILIM","2":"GND"}),
        ("R7","5.1k",R08,138,155,{"1":"USB_CC1","2":"GND"}),
        ("R8","5.1k",R08,135,158.5,{"1":"USB_CC2","2":"GND"}),
        ("R9","470R",R08,132,155,{"1":"VBUS_USB","2":"LED_PWR_A"}),
        ("R10","470R",R08,135,155,{"1":"VBUS_USB","2":"LED_CHG_A"}),

...
SYN = [
 ...
 ('filter', 'notch vibration'), ('blackbox', 'log logging flight record recorder'), ('sim', 'simulator realflight next joystick usb'), ('usb', 'socket cable usb-c flight controller dongle simulator'), ('port', 'ports uart socket wire crsf msp serial'),
